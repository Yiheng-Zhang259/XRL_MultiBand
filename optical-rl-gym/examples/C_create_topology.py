...
topology = get_topology('/content/ProjectFiles/New_topologies/German_topology.txt', 'German', k_paths=k_paths)

with open('ProjectFiles/optical-rl-gym/examples/topologies/German_chen_5-paths.h5', 'wb') as f:
