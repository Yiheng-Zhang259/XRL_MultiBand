    ...
    def observation(self):
        ...
        for idp, path in enumerate(self.k_shortest_paths[self.service.source, self.service.destination]): 
            ...
            for idband in range(self.bands):        #including bands
                ...
                idx, values, lengths = DeepRMSAKSPEnv.rle(available_slots)
...
def shortest_path_first_fit(env: DeepRMSAKSPEnv) -> int:
...
def shortest_available_path_first_fit(self: DeepRMSAKSPEnv) -> int:
