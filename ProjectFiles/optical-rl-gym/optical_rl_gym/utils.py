...
class Path:
    ...
    def __init__(self, path_id, node_list, length, best_modulationC=None, best_modulationL=None, best_modulationS=None, best_modulationE=None):
        self.path_id = path_id
        self.node_list = node_list
        self.length = length
        self.best_modulationC = best_modulationC
        self.best_modulationL = best_modulationL        #added multiple bands
        self.best_modulationS = best_modulationS
        self.best_modulationE = best_modulationE
...
class Service:
    ...
    def __init__(self, service_id, source, source_id, destination=None, destination_id=None, arrival_time=None,
                 holding_time=None, bit_rate=None, best_modulationC=None,best_modulationL=None, best_modulationS=None, best_modulationE=None, band=None, service_class=None, number_slots=None):  #add S and E when using
        ...
        self.band = band
        self.best_modulationC = best_modulationC
        self.best_modulationL = best_modulationL  #added bands
        self.best_modulationS = best_modulationS
        self.best_modulationE = best_modulationE
