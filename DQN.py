...
for i, j in zip(load, holding_time):
  ...
  model = DQN('MlpPolicy', training_env, verbose=0, tensorboard_log="/content/tb/German_CLSE_4000/DQN-DeepRMSA-v0/", gamma=.95, policy_kwargs=policy_kwargs,
             learning_rate=10e-5)
  ...
  model.save("/content/XRL_MultiBand/DQN_results/German/CLSE/{}/tmp1/best".format(i))
  # Helper from the library
  results_plotter.plot_results([log_dir], 1e5, results_plotter.X_TIMESTEPS, "German_CLSE_4000_100k")
  plt.savefig("/content/Results/German_5-paths_CLSE_4000_100k.png")
