...
for i, j in zip(load, holding_time):
  log_dir = "/content/XRL_MultiBand/DQN_results/German/C/{}/tmp1/".format(i)
  ...
  model = DQN(MlpPolicy, training_env, verbose=0, tensorboard_log="/content/tb/German_C_4000/DQN-DeepRMSA-v0/", double_q=False, gamma=.95, policy_kwargs=policy_kwargs,
             learning_rate=10e-5)
  ...
  a = model.learn(total_timesteps=100000, callback=callback)
  ...
  model.save("/content/XRL_MultiBand/DQN_results/German/C/{}/tmp1/best".format(i))
  # Helper from the library
  results_plotter.plot_results([log_dir], 1e5, results_plotter.X_TIMESTEPS, "German_C_4000_100k")
  plt.savefig("/content/Results/German_5-paths_C_4000_100k.png")
