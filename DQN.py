...
for i, j in zip(load, holding_time):
  ...
  model = DQN('MlpPolicy', training_env, verbose=0, tensorboard_log="/content/tb/German_C_4000/DQN-DeepRMSA-v0/", gamma=.95, policy_kwargs=None,
             learning_rate=10e-5)
  ...
  a = model.learn(total_timesteps=1000, callback=callback)
